...
sed -i -e "s/%define release_extra.*/%define release_extra ${PRODUCT_LABEL}${PRODUCT_VERSION}/g" kdreg2.spec
sed -i -e "s/Release:.*/Release: ${PRODUCT_LABEL}${PRODUCT_VERSION}_%(echo \\\${BUILD_METADATA:-1})/g" kdreg2.spec
